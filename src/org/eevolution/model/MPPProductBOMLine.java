...
public class MPPProductBOMLine extends X_PP_Product_BOMLine
{
	...
	/** Andrés López - 24/02/2015
	 * Comentar el código Low Level, toma mucho tiempo modificar BOM
	 * 
	...
	*/
	...
	/*	int lowlevel = getLowLevel(); - Andres Lopez BOM lento */
		MProduct product = new MProduct(getCtx(), getM_Product_ID(), get_TrxName());
	/*	product.setLowLevel(lowlevel); //update lowlevel - Andres Lopez BOM lento */
		product.saveEx();
