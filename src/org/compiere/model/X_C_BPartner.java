...
public class X_C_BPartner extends PO implements I_C_BPartner, I_Persistent 
{
    ...
    public I_LCO_TaxIdType getLCO_TaxIdType() throws Exception
{
    Class<?> clazz = MTable.getClass(I_LCO_TaxIdType.Table_Name);
    I_LCO_TaxIdType result = null;
    try        {
            Constructor<?> constructor = null;
                constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
            result = (I_LCO_TaxIdType)constructor.newInstance(new Object[] {getCtx(), new Integer(getLCO_TaxIdType_ID()), get_TrxName()});
    } catch (Exception e) {
            log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
            log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
       throw e;
    ...
    public I_LCO_TaxPayerType getLCO_TaxPayerType() throws Exception
{
    Class<?> clazz = MTable.getClass(I_LCO_TaxPayerType.Table_Name);
    I_LCO_TaxPayerType result = null;
    try        {
            Constructor<?> constructor = null;
                constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
            result = (I_LCO_TaxPayerType)constructor.newInstance(new Object[] {getCtx(), new Integer(getLCO_TaxPayerType_ID()), get_TrxName()});
    } catch (Exception e) {
            log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
            log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
       throw e;
