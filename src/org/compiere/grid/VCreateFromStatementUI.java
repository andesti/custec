...
public class VCreateFromStatementUI extends CreateFromStatement implements ActionListener
{
	...
	private CLabel dateFromLabel = new CLabel(Msg.translate(Env.getCtx(), "DateAcct"));//DateTrx
	...
	private CLabel dateFrom1Label = new CLabel(Msg.translate(Env.getCtx(), "Fecha_chq"));//DateTrx
	protected VDate dateFrom1Field = new VDate("DateFrom1", false, false, true, DisplayType.Date, Msg.translate(Env.getCtx(), "DateFrom1"));
	private CLabel dateTo1Label = new CLabel("-");
	protected VDate dateTo1Field = new VDate("DateTo1", false, false, true, DisplayType.Date, Msg.translate(Env.getCtx(), "DateTo1"));
    ...
    private void jbInit() throws Exception
    {
    	...
    	dateFrom1Label.setLabelFor(dateFrom1Field);
    	dateFrom1Field.setToolTipText(Msg.translate(Env.getCtx(), "DateFrom1"));
    	dateTo1Label.setLabelFor(dateTo1Field);
    	dateTo1Field.setToolTipText(Msg.translate(Env.getCtx(), "DateTo1"));
    	...
    	//
    	parameterBankPanel.add(CheckNoLabel, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0
    			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
    	parameterBankPanel.add(CheckNoField, new GridBagConstraints(3, 4, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	//
    	
    	
    	
    	parameterBankPanel.add(dateFrom1Label, new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0
    			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
    	parameterBankPanel.add(dateFrom1Field, new GridBagConstraints(3, 5, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	parameterBankPanel.add(dateTo1Label, new GridBagConstraints(4, 5, 1, 1, 0.0, 0.0
    			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
    	parameterBankPanel.add(dateTo1Field, new GridBagConstraints(5, 5, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
...
//		Object source = e.getSource();
	...
	{
		loadTableOIS(getBankData(documentNoField.getText(),CheckNoField.getText(), bPartnerLookup.getValue(), dateFromField.getValue(), dateToField.getValue(),
				dateFrom1Field.getValue(), dateTo1Field.getValue(),
