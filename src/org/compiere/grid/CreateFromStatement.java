...
public class CreateFromStatement extends CreateFrom 
{
	 ...
	 */
	public String getSQLWhere(String DocumentNo,String CheckNo, Object BPartner, Object DateFrom, Object DateTo, 
			Object DateFrom1, Object DateTo1, 
			Object AmtFrom, Object AmtTo, Object DocType, Object TenderType, String AuthCode)
	{
		...
		{
			Timestamp from = (Timestamp) DateFrom1;
			Timestamp to = (Timestamp) DateTo1;
			if (from == null && to != null)
				sql.append(" AND TRUNC(p.fecha_chq) <= ?");
			else if (from != null && to == null)
				sql.append(" AND TRUNC(p.fecha_chq) >= ?");
			else if (from != null && to != null)
				sql.append(" AND TRUNC(p.fecha_chq) BETWEEN ? AND ?");
		}
	...
	void setParameters(PreparedStatement pstmt, boolean forCount, 
			String DocumentNo,String CheckNo, Object BPartner, Object DateFrom, Object DateTo, 
			Object DateFrom1, Object DateTo1,
			Object AmtFrom, Object AmtTo, Object DocType, Object TenderType, String AuthCode) 
	throws SQLException
	{
	...
	protected Vector<Vector<Object>> getBankData(String DocumentNo, String CheckNo,Object BPartner, Object DateFrom, Object DateTo,
			Object DateFrom1, Object DateTo1,
			Object AmtFrom, Object AmtTo, Object DocType, Object TenderType, String AuthCode)
	{
		Vector<Vector<Object>> data = new Vector<Vector<Object>>();
		
		String sql = "SELECT p.DateAcct,p.C_Payment_ID,p.DocumentNo, p.C_Currency_ID,c.ISO_Code, p.PayAmt,"
			+ "currencyConvert(p.PayAmt,p.C_Currency_ID,ba.C_Currency_ID,pay.DateAcct,p.C_ConversionType_ID,p.AD_Client_ID,p.AD_Org_ID),"
			+ " bp.Name,pay.CheckNo,pay.A_NAME,pay.fecha_chq "
		...
		sql = sql + getSQLWhere(DocumentNo,CheckNo, BPartner, DateFrom, DateTo, DateFrom1, DateTo1,AmtFrom, AmtTo, DocType, TenderType, AuthCode) + " ORDER BY p.DateAcct";
		...
		try
		{
			...
			setParameters(pstmt, false, DocumentNo,CheckNo, BPartner, DateFrom, DateTo,DateFrom1, DateTo1, AmtFrom, AmtTo, DocType, TenderType, AuthCode);
			...
			while (rs.next())
			{
				...
				line.add(rs.getString(9));      	//  7- cheque
				line.add(rs.getString(10));      	//  8- girado A
				line.add(rs.getString(11));      	//  9- fecha_cqh
	...
	protected void configureMiniTable (IMiniTable miniTable)
	{
		...
		miniTable.setColumnClass(7, String.class, true);    	//  7-cheque
		miniTable.setColumnClass(8, String.class, true);    	//  8-A_name
		miniTable.setColumnClass(9, String.class, true);    	//  9-fecha_chq
	...
	protected Vector<String> getOISColumnNames()
	{
		...
		columnNames.add(Msg.translate(Env.getCtx(), "Fecha_Chq"));
